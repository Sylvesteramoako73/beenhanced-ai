    ...
    <div className="min-h-screen bg-brand-black flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-muted text-xs tracking-[0.3em] uppercase">AI Assistant</p>
        </div>

        {/* Card */}
        <div className="bg-brand-dark border border-brand-mid rounded-lg p-8">
          <h2 className="font-heading text-2xl font-light text-center text-white mb-1">Welcome back</h2>
          <p className="text-text-muted text-sm text-center mb-8">Enter your access password to continue</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? "Authenticating…" : "Access Assistant"}
            </button>
          </form>
        </div>

        <p className="text-text-dim text-xs text-center mt-6">
          Restricted access — BeEnhanced personnel only
        </p>
      </div>
    </div>
  );
